...
class AppEdgeInsets {
  ...
  EdgeInsets all(double value) => EdgeInsets.symmetric(vertical: value.toHeight, horizontal: value.toWidth);

  EdgeInsets only({double left = 0.0, double top = 0.0, double right = 0.0, double bottom = 0.0}) =>
      EdgeInsets.only(top: top.toHeight, bottom: bottom.toHeight, left: left.toWidth, right: right.toWidth);
